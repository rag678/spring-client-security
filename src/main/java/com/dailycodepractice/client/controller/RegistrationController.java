...
import com.dailycodepractice.client.model.PasswordModel;
...
public class RegistrationController {
    ...
    public String resendVerificationToken(@RequestParam("token") String oldToken,
        ...
        resendVerificationTokenMail(user,apliactionUrl(request),verificationToken);
    ...
    public String resetPassword(@RequestBody PasswordModel passwordModel,HttpServletRequest request){
        ...
        if(user != null){
            ...
            url = passwordResetTokenMail(user,apliactionUrl(request),token);
        }
        return url;
    }
    ...
    private String passwordResetTokenMail(User user, String apliactionUrl, String token) {
        String url = apliactionUrl + "/savePassword?token="+token;
    ...
    private void resendVerificationTokenMail(User user, String apliactionUrl, VerificationToken verificationToken) {
        String url = apliactionUrl + "/verifyRegistration?token="+verificationToken.getToken();
